 ...
 * @version        Release: 1.0
 * @filesource     wp-content/themes/touko-the-politician/facebook/get-facebook-posts.php
 * @since          available since Release 1.0
 */
  require_once(get_stylesheet_directory() . '/vendor/facebook/facebook.php');

  global $facebook_data, $touko_the_politician_theme_options_settings;
