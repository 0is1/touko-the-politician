...
<div class="facebook-options">
  <div class="facebook-app-settings">
    ...
    <div class="wrap pure-control-group">
      <label for="touko_theme_options[facebook_app_secret]"><?php _e( 'App Secret:', THEME_TEXTDOMAIN );?></label>
...
<div class="twitter-options">
  <div class="twitter-app-settings">
    ...
    <div class="wrap pure-control-group">
      <label for="touko_theme_options[twitter_consumer_secret]"><?php _e( 'Twitter Consumer Secret:', THEME_TEXTDOMAIN );?></label>
      <input type="text" name="touko_theme_options[twitter_consumer_secret]" value="<?php echo $options['twitter_consumer_secret'];?>"  />
    </div>
    <div class="wrap pure-control-group">
      <label for="touko_theme_options[twitter_oauth_access_token]"><?php _e( 'Twitter OAuth Access Token:', THEME_TEXTDOMAIN );?></label>
      <input type="text" name="touko_theme_options[twitter_oauth_access_token]" value="<?php echo $options['twitter_oauth_access_token'];?>"  />
    </div>
    <div class="wrap pure-control-group">
      <label for="touko_theme_options[twitter_oauth_access_token_secret]"><?php _e( 'Twitter OAuth Access Token Secret:', THEME_TEXTDOMAIN );?></label>
  ...
  <div class="twitter-newsfeed-settings">
    ...
    <div class="wrap pure-control-group">
      <label for="touko_theme_options[twitter_visible_posts_count]"><?php _e( 'Tweettien määrä etusivulla:', THEME_TEXTDOMAIN );?></label>
