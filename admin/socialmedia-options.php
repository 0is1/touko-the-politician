...
<div class="social-media-link-options">
  ...
  <div class="pure-control-group wrap twitter">
    <label for="touko_theme_options[twitter_page_url]"><?php _e( 'Twitter', THEME_TEXTDOMAIN );?></label>
  ...
  <div class="pure-control-group wrap rss">
    <label for="touko_theme_options[rss_page_url]"><?php _e( 'RSS', THEME_TEXTDOMAIN );?></label>
  ...
  <div class="pure-control-group wrap donate">
    <label for="touko_theme_options[donate_url]"><?php _e( 'Lahjoitusnappi', THEME_TEXTDOMAIN );?></label>
